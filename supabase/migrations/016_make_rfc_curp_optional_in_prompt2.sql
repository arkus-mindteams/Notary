-- Migración: Actualizar PROMPT 2 para hacer explícito que RFC y CURP son opcionales
-- Motivo: RFC y CURP no son datos obligatorios ni para vendedores ni para compradores.
-- Si vienen en documentos procesados, se capturan; si no, no se solicitan.

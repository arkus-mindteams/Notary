...
function buildDefaultPrompt(): string {
  return [
    ...
    "  - Si el documento dice '7.43' → devolver 7.43 (NO 7.430)",
    "  - Si el documento dice '7.430' → devolver 7.430 (NO 7.43)",
    "  - Si el documento dice '7.4' → devolver 7.4 (NO 7.400)",
    "  - Si el documento dice '7.4000' → devolver 7.4000 (preservar todos los decimales)",

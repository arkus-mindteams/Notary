...
const gptCapture = new ProposeStateUpdateAgent()
...
export function createDirectChatGPTRouteHandler(deps: RouteDeps = defaultDeps) {
  return async function POST(req: Request) {
    try {
      ...
      const proposal = await gptCapture.propose({
      ...
      let responsePayload: Record<string, unknown> = {
        intent: 'UPDATE_STATE',
        agent_used: 'ChatGPTCaptureEngine',
...
export const POST = createDirectChatGPTRouteHandler()

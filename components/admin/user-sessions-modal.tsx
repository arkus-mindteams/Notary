                                                        ...
                                                        <div className="flex items-start gap-4">
                                                            <div className={cn(
                                                                ...
                                                                session.isOrphan
                                                                    ...
                                                                    : session.isPlan
                                                                        ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-600 dark:text-emerald-500 group-hover:bg-emerald-500/15"
                                                                        : "bg-primary/5 border-primary/10 text-primary group-hover:bg-primary/10 group-hover:border-primary/20"
                                                            )}>
                                                                {session.isOrphan ? <AlertTriangle className="h-5 w-5" /> : session.isPlan ? <Zap className="h-5 w-5" /> : <MessageSquare className="h-5 w-5" />}
                                                            </div>

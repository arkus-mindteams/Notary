...
export function DocumentSidebar({ data, serverState, isVisible }: DocumentSidebarProps) {
    ...
    return (
        <Card className="w-80 border-l border-gray-200 rounded-none shadow-none bg-white flex flex-col h-full">

...
export class PreavisoExtractionPlugin implements ExtractionPlugin<typeof preavisoExtractionSchema> {
  ...
  buildSystemPrompt(_input: ExtractionInput): string {
    return [
      ...
      'MODO BATCH: si el texto contiene marcadores "--- DOCUMENTO N ---", procesa TODOS los documentos y consolida en una sola salida.',
  ...
  "source_refs": [{ "field": "campo", "evidence": "texto exacto de respaldo" }]
    ...
    return [
      ...
      '- Si el texto esta consolidado por bloques "--- DOCUMENTO N ---", debes leer todos los bloques antes de responder.',
